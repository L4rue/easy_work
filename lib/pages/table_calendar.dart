...
import 'package:easy_work/pages/custom_calendar/custom_cell_content.dart';
        ...
        children: [
          ...
          TableCalendar<Event>(
            calendarBuilders: CalendarBuilders(
                defaultBuilder: getCellBuilder(),
                todayBuilder: getCellBuilder(isToday: true),
                outsideBuilder: getCellBuilder(isOutside: true),
                selectedBuilder: getCellBuilder(isSelected: true),
                holidayBuilder: getCellBuilder(isHoliday: true),
