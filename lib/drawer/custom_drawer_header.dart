...
class CustomUserAccountsDrawerHeader extends StatefulWidget {
  ...
  @override
  State<CustomUserAccountsDrawerHeader> createState() => _CustomUserAccountsDrawerHeader();
}

class _CustomUserAccountsDrawerHeader extends State<CustomUserAccountsDrawerHeader> {
  bool _isOpen = false;
